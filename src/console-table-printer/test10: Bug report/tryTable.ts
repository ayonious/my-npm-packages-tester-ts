...
t.addRow({bob: "sjfkls jfkl fklsj fkls jfkls jklf sklfj sklf jskld fj", fred: "dfjskldf jklsdjf klsdj fklsd jfkl"});
t.printTable();
...
const data2 = [
  ...
  {
    "code": "DBT-02-002",
    "message": "There should be a properly named yaml file in each leaf directory",
    "path": "refined_zone/core/real_estate/aggregations/econ_markets/reference_data/market_grouping",
